import { parcerXmi } from "./Utility/ParserXmi";

/**
 * Adds the label menu items to the given menu and parent.
 */
export var saveFile = function (ui, forceDialog) {
...
/**
 * Function save to a xmi file
 * @param {*} ui 
 * @param {*} forceDialog 
 */
export const saveFileXMI = function (ui, forceDialog) {
  if (!forceDialog && ui.editor.filename != null) {
    ui.save(ui.editor.getOrCreateFilename());
  } else {
...
/**
 * Function save xmi file
 * @param {*} ui 
 * @param {*} name 
 * @returns 
 */
const saveXMI = function (ui, name) {
  if (name != null) {
    if (ui.editor.graph.isEditing()) {
      ui.editor.graph.stopEditing();
    }
